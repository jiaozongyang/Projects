...
```{r}
df = read.csv("/Users/zongyangjiao/Desktop/DSO562_Fraud Analytics/project1/NY_property.csv",
              header = T, stringsAsFactors = F)

df = df[,c('BBLE','FULLVAL','AVLAND','AVTOT','B','BLOCK','BLDGCL','TAXCLASS','ZIP','LTFRONT','LTDEPTH', 'BLDFRONT','BLDDEPTH','STORIES')]
```
